...
cbNivCatDropDown = CreateFrame("Frame", "cbNivCatDropDown", UIParent, "XUIDropDownMenuTemplate")
...
function cargBags_Nivaya:ADDON_LOADED(event, addon)
    ...
    LoadDefaults()
    XUIDropDownMenu_Initialize(cbNivCatDropDown, cbNivaya.CatDropDownInit, "MENU")
    ...
    cB_Bags.main:SetPoint("RIGHT", -11, -231)
    cB_Bags.bank:SetPoint("TOPLEFT", 11, -61)
...
function cbNivaya:CreateAnchors()
    ...
    CreateAnchorInfo(cB_Bags.consumables, cB_Bags.battlepet, "Top")
	CreateAnchorInfo(cB_Bags.battlepet, cB_Bags.quest, "Top")
